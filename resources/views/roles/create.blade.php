      ...
      @endif
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <form action="{{ route('roles.store') }}" method="post" id="utype-form" enctype="multipart/form-data" class="smart-form">
                            @csrf
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                @if($menu->is_parent==1 ||($menu->is_parent==0 && $menu->parent_order != '' ))
                                                <!--||($menu->is_parent==0 && $menu->parent_order != '' )-->
