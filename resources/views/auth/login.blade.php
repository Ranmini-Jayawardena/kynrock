...
<x-guest-layout>
    <div id="main" role="main">
        ...
        <div class="hero login_heading" style="background-image: none;">
            <h1 class="main_heading">Good Wood Airport Hotel</h1>
            <h1 class="sub_heading">CONTENT MANAGEMENT SYSTEM</h1>
        </div>
        ...
        <div id="content" class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 login_form_div">
                    ...
                    <p class="lang_p" style="text-align: right; margin-top: 15px; position: relative; margin-bottom: 15px; padding-right: 15px;">
                    ...
                    <div class="well no-padding" style="box-shadow: none; background-color: transparent;">
                        ...
                        <img src="{{ asset('public/back/img/seaworld_logo.png') }}" alt="" class="img-responsive labor_logo center-block" style="padding-left: 15px; padding-right: 15px; margin-bottom: 15px; height:150px;">
