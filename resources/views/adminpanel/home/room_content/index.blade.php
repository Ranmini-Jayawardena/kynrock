    ...
    <div id="main" role="main">
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <header>
                    <h2>{{ __('Home Page - Room Content') }}</h2>
                </header>
                <div>
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-room-content') }}" enctype="multipart/form-data" method="post"
                            id="room-content-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
