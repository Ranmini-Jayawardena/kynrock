    ...
    <div id="main" role="main">
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <header>
                    <h2>{{ __('Home Page - Features Content') }}</h2>
                </header>
                <div>
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-features-content') }}" enctype="multipart/form-data" method="post"
                            id="features-content-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
                                ...
                                <div class = "row">
                                    <section class="col col-3">
                                        <label class="label">{{ __('Image') }} (1920 x 660) <span
                                                style=" color: red;">*</span></label>
                                        <label class="input">
