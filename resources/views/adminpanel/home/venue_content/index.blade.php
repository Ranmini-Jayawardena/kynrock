            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-venue-content') }}" enctype="multipart/form-data" method="post"
                            id="venue-content-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
