            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-main-slider') }}" enctype="multipart/form-data" method="post"
                            id="main-slider-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
                                    <section class="col col-2">
                                        ...
                                        <label class="input">
                                            <input type="file" class="form-control form-input" id="image_name"
                                                name="image_name" style="overflow: hidden;">
                                        </label>
                                    </section>
                                    <section class="col col-2">
                                        @if ($data->image_name)
                                            <img id="preview-image-before-upload"
                                                src="../storage/app/{{ $data->image_name }}" alt="preview image"
