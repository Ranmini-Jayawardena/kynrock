            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-testimonial-content') }}" enctype="multipart/form-data"
                            method="post" id="testimonial-content-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="name" name="name" required maxlength="191" value="">
                                        </label>
                                    </section>
                                ...
                                <div class="row">
                                    <section class="col col-11" style="width: 100%;">
                                        <label class="label">{{ __('Testimonial') }}<span
                                                style=" color: red;">*</span></label>
                                        <label class="input">
                                            <textarea class="form-control summernote" id="testimonial" name="testimonial" rows="3" required></textarea>
    ...
    <x-slot name="script">
        ...
        <script>
            $(function() {
                ...
                $('#testimonial-content-form').parsley();
            });
