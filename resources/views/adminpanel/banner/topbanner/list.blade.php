...
<x-app-layout>
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="top-banner-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('No') }}</th>
                                                <th>{{ __('Heading') }}</th>
                                                <th width="250px">{{ __('Image') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            // $('#brochures-table').on('click', '.btn-delete', function(e) {
            ...
            //     }).then(function(value) {
            //         if (value == true) {
            //             window.location.replace("blockbrochure/" + id);
            //         }
            //     });
            // });
        </script>
