            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-meta-tag') }}" enctype="multipart/form-data" method="post"
                            id="age-contentce-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <header>
                                {{ $data->page_name }}
                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-12" style="width: 100%;">
                                        <label class="label">{{ __('Page Title') }} <span
                                ...
                                <div class="row">
                                    <section class="col col-4">
                                        <img id="preview-image-before-upload"
                                            src="../../storage/app/{{ $data->og_image }}" alt="preview image"
                                    ...
                                    <section class="col col-12" style="width: 100%;">
                                        ...
                                        <label class="input">
                                            <input type="text" id="og_sitename" name="og_sitename"
                                                value="{{ $data->og_sitename }}" required>
                                        </label>
                                    </section>
                                </div>
                                <div class="row">
