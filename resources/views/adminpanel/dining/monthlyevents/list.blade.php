...
<x-app-layout>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%"
                                        id="monthly-event-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('No') }}</th>
                                                <th>{{ __('Monthly Event List') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'monthlyevent_name',
                            name: 'monthlyevent_name'
                        },
                        {
                            data: 'edit',
                            name: 'edit',
                        ...
                        {
                            data: 'blockmonthlyevent',
                            name: 'blockmonthlyevent',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#monthly-event-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockmonthlyevent/" + id);
                    }
                });
            });
        </script>
