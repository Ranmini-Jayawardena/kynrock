...
<x-app-layout>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            <header>
                                ...
                                <h2>{{ __('Terms and Conditions List') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="terms-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('No') }}</th>
                                                <th >{{ __('Title') }}</th>
                                                <th width="150px">{{ __('Order') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            $('#terms-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockterms/" + id);
                    }
                });
            });
        </script>
