                ...
                <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <form action="{{ route('save-wedding-venue') }}" enctype="multipart/form-data"
                                method="post" id="wedding-venue-form" class="smart-form">
                                @csrf
                                @method('PUT')
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-4">
                                            ...
                                            <label class="select">
                                                <select name="sub_category_id" disabled>
                                                    <option value="">{{ __('Select Subcategory') }}</option>
                                                    <option value="{{ $data->subCategory->id }}" selected>
                                                        {{ $data->subCategory->sub_category_name }}
                                                    </option>
                                                </select>
                                                <i></i>
                                            </label>
                                            <input type="hidden" name="sub_category_id" value="{{ $data->subCategory->id }}">
                                        ...
                                        <section class="col col-2">
                                            ...
                                            @else
                                                <img id="preview-image-before-upload"
                                                    ...
                                                    alt="default image" style="max-height: 250px;">
                                            @endif
                                        </section>
                                    </div>
                                </fieldset>
