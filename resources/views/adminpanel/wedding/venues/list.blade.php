...
<x-app-layout>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'blockweddingvenuefeatures',
                            name: 'blockweddingvenuefeatures',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#wedding-venue-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockweddingvenuefeatures/" + id);
                    }
                });
            });
        </script>
