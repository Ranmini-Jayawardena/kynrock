                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            @if ($subCategories->isNotEmpty())
                                <form action="{{ route('new-wedding-venue') }}" enctype="multipart/form-data"
                            ...
                            @else
                                <div class="alert alert-info" style="margin-top:20px;">
                                    {{ __('All subcategories already have created. To add a new venue, please create a new subcategory in the Gallery section.') }}
                                </div>
                            @endif
                        </div>
                        <!-- end widget content -->
