@section('title', 'Wedding Hotel Features List')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('wedding-hotel-features') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('Add New') }}</button>
                        </a>

                        <a href="{{ route('wedding-hotel-features-list') }}">
                            <button
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%"
                                        id="wedding-hotel-features-table">
                                        <thead>
                                            <tr>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('wedding-hotel-features-list') }}",
                    // order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blockweddinghotelfeatures',
                            name: 'blockweddinghotelfeatures',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#wedding-hotel-features-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockweddinghotelfeatures/" + id);
                    }
                });
            });
        </script>
