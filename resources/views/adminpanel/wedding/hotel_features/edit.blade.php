...
<x-app-layout>
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-wedding-hotel-features') }}" enctype="multipart/form-data" method="post"
                            id="wedding-hotel-features-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
    ...
    <x-slot name="script">
        <script>
            $(function() {
                $('#wedding-hotel-features-form').parsley();
