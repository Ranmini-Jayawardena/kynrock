@section('title', 'Wedding Features List')
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('wedding-features-list') }}",
                    // order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blockweddingfeatures',
                            name: 'blockweddingfeatures',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#wedding-features-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockweddingfeatures/" + id);
                    }
                });
            });
        </script>
