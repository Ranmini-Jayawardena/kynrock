@section('title', 'Wedding Packages Edit')
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('wedding-package') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('Add New') }}</button>
                        </a>

                        <a href="{{ route('wedding-package-list') }}">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-wedding-package') }}" enctype="multipart/form-data" method="post"
                            id="wedding-package-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        <label class="label">{{ __('Package Name') }} <span
                                                style=" color: red;">*</span></label>
                                        <label class="input">
                                            <input type="text" id="package_name" name="package_name"
                                                value="{{ $data->package_name }}"required maxlength="191">
                                        </label>
                                    </section>
                                    <section class="col col-4">
