@section('title', 'Wedding Dining Features')
<x-app-layout>
    <x-slot name="header">
    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <header>
                    <h2>{{ __('Wedding Dining Features') }}</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget edit box -->
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-wedding-dining-features') }}" enctype="multipart/form-data"
                            method="post" id="wedding-dining-features-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
