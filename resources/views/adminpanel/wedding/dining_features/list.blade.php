@section('title', 'Wedding Dining Features List')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('wedding-dining-features') }}">
                            <button class="btn cms_top_btn top_btn_height ">{{ __('Add New') }}</button>
                        </a>

                        <a href="{{ route('wedding-dining-features-list') }}">
                            <button
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types"
                            ...
                            <header>
                                ...
                                <h2>{{ __('Wedding Dining Features List') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%"
                                        id="wedding-dining-features-table">
                                        <thead>
                                            <tr>
                                                <th width="100px">{{ __('No') }}</th>
                                                <th>{{ __('Dining Feature Name') }}</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('wedding-dining-features-list') }}",
                    // order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blockweddingdiningfeatures',
                            name: 'blockweddingdiningfeatures',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#wedding-dining-features-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockweddingdiningfeatures/" + id);
                    }
                });
            });
        </script>
