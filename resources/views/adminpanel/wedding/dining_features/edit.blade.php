@section('title', 'Wedding Dining Features Edit')
<x-app-layout>
    <x-slot name="header">
    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <header>
                    <h2>{{ __('Wedding Dining Features Edit') }}</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget edit box -->
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-wedding-dining-features') }}" enctype="multipart/form-data" method="post"
                            id="wedding-dining-features-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="feature_name" name="feature_name" maxlength="191"
    ...
    <x-slot name="script">
        <script>
            $(function() {
                $('#wedding-dining-features-form').parsley();
