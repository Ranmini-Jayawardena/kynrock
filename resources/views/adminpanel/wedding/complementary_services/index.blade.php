@section('title', 'Wedding Complementary Services List')
<x-app-layout>
    <x-slot name="header">
    ...
    <div id="main" role="main">
        ...
        <div id="content">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row cms_top_btn_row" style="margin-left:auto;margin-right:auto;">
                        <a href="{{ route('wedding-complementary-services') }}">
                            <button
                                class="btn cms_top_btn top_btn_height cms_top_btn_active">{{ __('Add New') }}</button>
                        </a>
                        <a href="{{ route('wedding-complementary-services-list') }}">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <header>
                    <h2>{{ __('Wedding Complementary Services') }}</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget edit box -->
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-wedding-complementary-services') }}" enctype="multipart/form-data"
                            method="post" id="wedding-complementary-services-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        <label class="label">{{ __('Service Name') }}<span
                                                style=" color: red;">*</span></label>
                                        <label class="input">
                                            <input type="text" id="service_name" name="service_name" required maxlength="191"
                                                value="">
                                        </label>
                                    </section>
    ...
    <x-slot name="script">
        ...
        <script>
            $(function() {
                $('#wedding-complementary-services-form').parsley();
            });
