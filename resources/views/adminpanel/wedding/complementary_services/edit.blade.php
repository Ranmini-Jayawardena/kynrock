@section('title', 'Wedding Complementary Services Edit')
<x-app-layout>
    <x-slot name="header">
    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <header>
                    <h2>{{ __('Wedding Complementary Services Edit') }}</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget edit box -->
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-wedding-complementary-services') }}" enctype="multipart/form-data"
                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="service_name" name="service_name" maxlength="191"
