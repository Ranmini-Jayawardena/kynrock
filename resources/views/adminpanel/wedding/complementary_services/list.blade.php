                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types"
                            ...
                            <header>
                                ...
                                <h2>{{ __('Wedding Complementary Services List') }}</h2>
                            </header>
                            <!-- widget div-->
                            <div>
                                <!-- widget edit box -->
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%"
                                        id="wedding-complementary-services-table">
                                        <thead>
                                            <tr>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('wedding-complementary-services-list') }}",
                    // order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blockcomplementaryservices',
                            name: 'blockcomplementaryservices',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#wedding-complementary-services-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockcomplementaryservices/" + id);
                    }
                });
            });
        </script>
