...
<x-app-layout>
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="location-table">
                                        <thead>
                                            <tr>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            $('#location-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blocklocation/" + id);
                    }
                });
            });
        </script>
