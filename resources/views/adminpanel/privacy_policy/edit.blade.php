            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-policy') }}" enctype="multipart/form-data" method="post" id="policy-form" class="smart-form">
                        @csrf
                        @method('PUT')
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="order" name="order" value="{{ $data->order }}" required min="0" max="255">
                                        </label>
                                    </section>
