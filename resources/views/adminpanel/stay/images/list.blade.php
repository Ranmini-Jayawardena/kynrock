                                    ...
                                    <table class="table table-bordered data-table" width="100%" id="images-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="150px">{{ __('Room Name') }}</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('roomtypeimages-list') }}",
                    // order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
                        ...
                        {
                            data: 'blockroomtypeimages',
                            name: 'blockroomtypeimages',
                            orderable: false,
                            searchable: false
                        },
                    ]
            ...
            $('#images-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockroomtypeimages/" + id);
                    }
                });
            });
        </script>
