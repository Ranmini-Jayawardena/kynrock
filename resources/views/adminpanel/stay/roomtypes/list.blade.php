...
<x-app-layout>
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="roomtypes-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('No') }}</th>
                                                <th>{{ __('Room Type Name') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            $('#roomtypes-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockroomtype/" + id);
                    }
                });
            });
        </script>
