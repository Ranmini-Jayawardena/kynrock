            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('new-roomtypes') }}" enctype="multipart/form-data" method="post" id="room-form" class="smart-form">
                            @csrf
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        <label class="label">{{ __('Room Name') }}<span style=" color: red;">*</span> </label>
                                        <label class="input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <section class="col col-12">
                                            ...
                                            <label class="checkbox" style="display: flex; align-items: center; gap: 10px;">
                                                    ...
                                                    <input type="checkbox" name="amenities[{{ $amenity->id }}]" value="1">
                                                    <i></i> {{ $amenity->amenties_name }}
                                                </label>
                                            @endforeach
                                        </section>
                                    ...
                                    <div class="row">
                                        <section class="col col-4">
                                            <label class="label">{{ __('Stay Page Content 1') }}  <span
                                                style="color: red;">*</span></label>
                                            <label class="input">
                                                <textarea class="form-control" id="home_content1" name="home_content1" rows="3" required></textarea>
                                            </label>
                                        </section>
                                        <section class="col col-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-2">
                                            <img id="preview-home_image" src="{{ asset('public/back/img/whitebg.jpg'); }}" alt="preview image" style="max-height: 250px;">
                                        </section>
                                    ...
                                    <div class="row">
                                        <section class="col col-12"  style="width: 100%;">
                                            <label class="label">{{ __('OG Description') }}<span style=" color: red;">*</span></label>
                                            <label class="input">
                                                <input type="text" id="og_description" name="og_description" required >
                                            </label>
                                        </section>
                                    </div>
