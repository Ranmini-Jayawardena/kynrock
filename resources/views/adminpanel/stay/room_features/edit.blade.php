@section('title', 'Room Features Edit')
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-room-features') }}" enctype="multipart/form-data" method="post"
                            id="room-features-form" class="smart-form">
                            @csrf
                            @method('PUT')
                            <fieldset>
                                <div class="row">
