@section('title', 'Room Amenities List')
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('room-amenities-list') }}",
                    // order: [ 1, 'asc' ],
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'id'
            ...
            $('#room-amenities-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockamenities/" + id);
                    }
                });
            });
        </script>
