@section('title', 'Room Amenities Edit')
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <form action="{{ route('save-room-amenities') }}" enctype="multipart/form-data" method="post"
                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                            <input type="text" id="amenties_name" name="amenties_name" maxlength="191"
                                                value="{{ $data->amenties_name }}"required>
                                        </label>
                                    </section>
