...
<x-app-layout>
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding table-responsive">
                                    <table class="table table-bordered data-table" width="100%" id="experience-table">
                                        <thead>
                                            <tr>
                                                <th>{{ __('No') }}</th>
                                                <th>{{ __('Experience Name') }}</th>
    ...
    <x-slot name="script">
        ...
        <script type="text/javascript">
            ...
            $('#experience-table').on('click', '.btn-delete', function(e) {
                ...
                swal({
                    ...
                    if (value == true) {
                        window.location.replace("blockexperience/" + id);
                    }
                });
            });
        </script>
