    ...
    public function boot()
    {
        ...
        View::composer('*', function ($view) {
            if (Auth::check()) {
                ...
                $subMenuItems = DynamicMenu::where('dynamic_menu.show_menu', 1)->where('dynamic_menu.parent_id', '!=', '0')->orderBy('child_order', 'ASC')->get();
        ...
        // Add custom type mapping if necessary
